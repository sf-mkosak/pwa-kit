...
- Add `/demo/mrt-data-store` demo page and `npm run start:mrt-data-store-demo` to exercise the Data Store locally (sample defaults in `scripts/mrt-data-store-demo.defaults.json`).
