## v10.1.0-dev
- [Bugfix] Fix PayPal/Venmo express checkout: resolve buyer-approved address from the upstream PayPal Order via `getBasket?expand=payment_references` (the SDK does not provide it client-side), and PATCH the basket payment instrument on shipping address change so the PayPal review screen reflects the new amount and shipping options. [#3881](https://github.com/SalesforceCommerceCloud/pwa-kit/pull/3881)
- Bump `main.js` bundle-size budget from 102 kB to 103 kB to accommodate the PayPal/Venmo express address-resolution and shipping-PATCH paths. [#3881](https://github.com/SalesforceCommerceCloud/pwa-kit/pull/3881)
