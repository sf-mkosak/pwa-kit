...
describe('Google API Key Resolution', () => {
    describe('resolveGoogleCloudAPIKey', () => {
        beforeEach(() => {
            // Mock getConfig to return a clean config
            jest.clearAllMocks()
        })
        ...
        test('should return null when platform provided key is not present', () => {
            const configurations = {
                configurations: []
            }

            const result = resolveGoogleCloudAPIKey(configurations)
            expect(result).toBeNull()
        })

        test('should return null when configurations is undefined', () => {
            const result = resolveGoogleCloudAPIKey(undefined)
            expect(result).toBeNull()
        })

        test('should return null when configurations is null', () => {
            const result = resolveGoogleCloudAPIKey(null)
            expect(result).toBeNull()
        })

        test('should return platform provided key when no custom key is configured', () => {
            const configurations = {
                configurations: [
                    {
                        id: 'gcp',
            ...
            const result = resolveGoogleCloudAPIKey(configurations)
            expect(result).toBe('platform-provided-key')
        })

        test('should return platform key when custom key is not configured', () => {
            const configurations = {
                configurations: [
                    {
                        id: 'gcp',
            ...
            // Test the function - it should return platform key when no custom key is configured
            const result = resolveGoogleCloudAPIKey(configurations)
            expect(result).toBe('platform-provided-key')
        })

        test('should return platform key when custom key is empty string', () => {
            const configurations = {
                configurations: [
                    {
                        id: 'gcp',
            ...
            // Mock getConfig to return empty custom key
            const mockGetConfig = jest.fn().mockReturnValue({
                app: {
                    googleCloudAPI: {
                        apiKey: ''
        ...
        test('should return platform key when custom key is null', () => {
            const configurations = {
                configurations: [
                    {
                        id: 'gcp',
            ...
            // Mock getConfig to return null custom key
            const mockGetConfig = jest.fn().mockReturnValue({
                app: {
                    googleCloudAPI: {
                        apiKey: null
        ...
        test('should return platform key when custom key is undefined', () => {
            const configurations = {
                configurations: [
                    {
                        id: 'gcp',
            ...
            // Mock getConfig to return undefined custom key
            const mockGetConfig = jest.fn().mockReturnValue({
                app: {
                    googleCloudAPI: {}
                }
