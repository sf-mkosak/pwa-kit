...
const ContactInfo = ({isSocialEnabled = false, idps = [], onRegisteredUserChoseGuest}) => {
    ...
    // Reset guest checkout flag when user becomes registered
    // This is handled directly in the places where registration status changes
    // instead of using useEffect to avoid unnecessary re-renders
