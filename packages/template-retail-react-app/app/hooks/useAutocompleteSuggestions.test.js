...
describe('useAutocompleteSuggestions', () => {
    ...
    describe('Google Cloud API Key Resolution', () => {
        const {getConfig} = require('@salesforce/pwa-kit-runtime/utils/ssr-config')

        beforeEach(() => {
            // Reset getConfig mock
            getConfig.mockReturnValue({
                app: {
                    googleCloudAPI: {
                        apiKey: 'custom-mrt-key'
                    }
                }
            })
        })

        it('should use custom MRT API key when both platform and custom keys are available', async () => {
            // Mock useCheckout to return platform key
            useCheckout.mockReturnValue({
                configurations: {
                    configurations: [
                        {
            ...
            // Mock getConfig to return custom key
            getConfig.mockReturnValue({
                app: {
                    googleCloudAPI: {
                        apiKey: 'custom-mrt-key'
        ...
        it('should use platform provided key when no custom key is available', async () => {
            // Mock useCheckout to return platform key
            useCheckout.mockReturnValue({
                configurations: {
                    configurations: [
            ...
            // Mock getConfig to return no custom key
            getConfig.mockReturnValue({
                app: {
                    googleCloudAPI: {
                        apiKey: undefined
        ...
        it('should not fetch suggestions when GCP configuration is not present (feature toggle disabled)', async () => {
            // Mock useCheckout to return no GCP configuration
            useCheckout.mockReturnValue({
                configurations: {
                    configurations: []
                }
        ...
        it('should not fetch suggestions when GCP configuration is present but has no value', async () => {
            // Mock useCheckout to return GCP configuration with no value
            useCheckout.mockReturnValue({
                configurations: {
                    configurations: [
                        {
        ...
        it('should handle missing configurations object gracefully', async () => {
            // Mock useCheckout to return no configurations object
            useCheckout.mockReturnValue({
                configurations: null
            })
        ...
        it('should handle undefined configurations gracefully', async () => {
            // Mock useCheckout to return undefined configurations
            useCheckout.mockReturnValue({
        ...
        it('should handle getConfig returning null gracefully', async () => {
            // Mock useCheckout to return platform key
            useCheckout.mockReturnValue({
                configurations: {
                    configurations: [
        ...
        it('should handle getConfig returning undefined app config gracefully', async () => {
            // Mock useCheckout to return platform key
            useCheckout.mockReturnValue({
                configurations: {
                    configurations: [
            ...
            // Mock getConfig to return undefined app config
            getConfig.mockReturnValue({
                app: undefined
            })
